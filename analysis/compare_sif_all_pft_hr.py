...
# Base file path
base_file_path = "/net/fluo/data3/data/FluoData1/students/renato/aviris_dangermond/fitting/pft_shift_fluxes_day_{}_h_lma.nc"

base_file_path_filter = "/net/fluo/data3/data/FluoData1/students/renato/aviris_dangermond/fitting/shift_fluxes_day_{}_reg_h_lma.nc"
...
try:
    file = open('pft_statistics_hr.txt', 'w')
...
for i, target_date_str in enumerate(dates):
    ...
    if valid_indices.any():
        ...
        plt.tight_layout()
        # Save the figure
        plt.savefig(f'pft_spatial_differences_{i}_hr.png',dpi=300)
        #plt.show()
        #sys.exit()
...
plt.tight_layout()
# Save the figure
plt.savefig(f'pft_spatial_differences_mean_hr.png', dpi=300)
