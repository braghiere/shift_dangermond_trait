...
base_file_path = "/net/fluo/data3/data/FluoData1/students/renato/aviris_dangermond/compare_sif/pft_shift_fluxes_day_{}_reg_tropomi.nc"
...
for i, target_date_str in enumerate(dates):
    ...
    if valid_indices.any():
        ...
        plt.tight_layout()
        # Save the figure
        plt.savefig(f'pft_spatial_differences_{i}.png',dpi=300)
        #plt.show()
        #sys.exit()
...
plt.tight_layout()
# Save the figure
plt.savefig(f'pft_spatial_differences_mean.png', dpi=300)
...
plt.legend()
plt.grid(True)
plt.savefig(f'pft_scatter_plot_all_trait.png')
plt.close()
