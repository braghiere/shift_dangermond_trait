...
- `figure_5_spatial_trait_maps_legible.py`: Regenerates Figure 5 (spatial trait maps) with enlarged axis/colorbar scale numbers (editor item 9), panel letters clear of the column titles, and LWC shown as g/cm² (×10⁻³) to match the Figure 4 histograms and §3.2.
