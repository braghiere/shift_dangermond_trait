...
function fit_shift_traits!(datafile::String = "/net/fluo/data1/students/renato/aviris_dangermond/aviris_dangermond_time_00/output_clipped.nc", ncresult::String = "shift_fittings1_test.nc")
