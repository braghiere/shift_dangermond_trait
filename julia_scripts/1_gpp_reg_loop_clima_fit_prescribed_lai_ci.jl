...
for (day_index, date) in enumerate(dates)
    ...
    chl_file = "/net/squid/data3/data/FluoData1/students/renato/aviris_dangermond/traits/datasets/clima_fit_prescribed_lai_ci/chl_aviris_dangermond_clima_fit_time_$(day_str)_reg.nc"
    ...
    vcm_file = "/net/squid/data3/data/FluoData1/students/renato/aviris_dangermond/traits/datasets/clima_fit_prescribed_lai_ci/lma_aviris_dangermond_clima_fit_time_$(day_str)_reg.nc"
    lwc_file = "/net/squid/data3/data/FluoData1/students/renato/aviris_dangermond/traits/datasets/clima_fit_prescribed_lai_ci/lwc_aviris_dangermond_clima_fit_time_$(day_str)_reg.nc"
    ...
    ncresult = "/net/fluo/data3/data/FluoData1/students/renato/aviris_dangermond/fitting/fitted_prescribed_lai_ci/shift_fluxes_day_$(day_str)_clima_fit_reg_jmax.nc"
